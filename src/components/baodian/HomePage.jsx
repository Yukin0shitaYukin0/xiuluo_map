...
const S = {
  ...
  title: {
    fontFamily: FONT, fontSize: '34px', fontWeight: 700,
    letterSpacing: '0.06em', marginBottom: '6px',
    ...textGradient(C.accent, C.accentGold),
  },
  subtitle: {
    fontSize: '14px', color: C.textMuted, fontFamily: FONT,
  ...
  statNum: {
    fontSize: '30px', fontWeight: 700, color: C.textPrimary,
  ...
  introBox: {
    ...
    borderRadius: '8px',
    fontSize: '14px', lineHeight: '2', color: C.textSecondary,
